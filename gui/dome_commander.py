...
class TrackingThread(QThread):
    ...
    def run(self):
        while self.is_tracking:
            if self.is_exceeding_limits or self.dome_az is None:
                ha, dec = 0, 0 #TODO: self._get_ha_dec()
                ...
                if az_new is not None:
                    ...
                    # TODO: send_command('goto ' + str(self.dome_az))
                    print('send command ....')
    ...
    def tracking_status_watcher(self):
        ...
        ha_cur, dec_cur = 0, 0 #self._get_ha_dec()
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _init_routine(self):
        ...
        # Get the default tracking aperture
    ...
    def update_widgets(self):
        ...
        scope_ha, scope_dec = 0, 0
        # Update the plot
        # self.plot(justify(dome_az), justify(scope_az))
        self.plot_dome(justify(dome_az), (scope_ha, scope_dec)) # TODO: include proper scope position
        ...
        idle_status = 'Yes' if not is_idle else 'No' #'Yes' if not is_dome_busy() else 'No'
    ...
    def on_azimuth_error(self):
        ...
        # self._log_message('ERROR... No azimuth available for the current telescope orientation! \
        #                    The dome remains at an azimuth of {:.0f} degrees for now...'.format(get_dome_pos()))
